...
{                                                                                       \    
    T = (int16_t)(SBE[(((X>>31)&0x01)^(X<<1)^*SK++)& 0x3F]);                             \
    T^= (int16_t)(SBE[((X>>3)^(*SK>>6))& 0x3F]<<4);                                     \
    T^= (int16_t)(SBE[((X>>7)^(*SK>>12))& 0x3F]<<8);                                    \
    T^= (int16_t)(SBE[((X>>11)^(*SK>>18))& 0x3F]<<12);                                  \
    T^= (int16_t)(SBE[((X>>15)^(*SK>>24))& 0x3F]<<16);                                  \
    T^= (int16_t)(SBE[((X>>19)^(*SK>>30)^(*SK++<<2))& 0x3F]<<20);                       \
    T^= (int16_t)(SBE[((X>>23)^(*SK>>4))& 0x3F]<<24);                                   \
    T^= (int16_t)(SBE[((X>>27)^(*SK>>10))& 0x3F]<<28);                                  \
      \
